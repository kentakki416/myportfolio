...
export const projects: Project[] = [
  ...
  },
  {
    ...
    slug: "sns-battle",
    title: "SNS Battle",
    des: "ライブ配信・1対1ビデオマッチング・観客付き対戦バトルを組み合わせた、リアルタイムソーシャルプラットフォームです。",
